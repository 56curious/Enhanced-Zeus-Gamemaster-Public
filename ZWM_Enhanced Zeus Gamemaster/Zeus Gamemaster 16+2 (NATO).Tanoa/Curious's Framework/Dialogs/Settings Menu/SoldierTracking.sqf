...
private [
	'_side','_sides','_QS_ST_X','QS_ST_map_enableUnitIcons','QS_ST_gps_enableUnitIcons',	'QS_ST_enableGroupIcons','_QS_ST_faction','_QS_ST_friendlySides_EAST',
...
_QS_ST_otherDisplays = TRUE;									// BOOL. TRUE to add Unit/Vehicle Icon support for UAV Terminal and Artillery Computer. Runs a separate script to handle these displays. Only works if  QS_ST_map_enableUnitIcons = TRUE;
...
_QS_ST_showEmptyVehicles = TRUE;								// BOOL. TRUE to mark certain unoccupied vehicles on the map. The vehicle must be assigned this variable:    <vehicle> setVariable ['QS_ST_drawEmptyVehicle',TRUE,TRUE];    Default FALSE.   Only works if  QS_ST_map_enableUnitIcons = TRUE;       CURIOUS - Add option for vehicle marking to players.
